...
class Person {
    //(\w+):\s.*
    //$1,
    constructor([name, nacionalidade, estadoCivil, documento, rua, numero, bairro, estado ]) {
        // ^ -> começo da string
        ...
        const formtFirstLetterExp = (prop) => {
        ...
        //this.$1 = $1;
        this.name = name;
        this.nacionalidade = formtFirstLetterExp(nacionalidade);
        this.estadoCivil = formtFirstLetterExp(estadoCivil);
